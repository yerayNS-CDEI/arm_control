...
class ConstrainedManipulabilityMod : public rclcpp::Node
{
    ...
    private:
        ...
        */
        ...
        bool evaluateCollisionState(const sensor_msgs::msg::JointState& joint_state, bool& self_collision, bool& env_collision);
        ...
        // addBranchCollisionGeometry adds collision geometry for branch links (e.g., sensor_plate, cylinder)
        // Returns vector of link names that were added
        ...
        std::set<std::pair<int, int>> collision_exclusions_;  // Pairs of link indices to exclude from self-collision
