...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'publisher_joint_trajectory_controller = control.publisher_joint_trajectory_controller:main',
            'publisher_joint_trajectory_planned = control.publisher_joint_trajectory_planned:main',
            'publisher_joint_trajectory_planned_topic = control.publisher_joint_trajectory_planned_topic:main',
