...
class PositionSenderNode(Node):
    def __init__(self):
        ...
        self.positions = {
            ...
            # scanning
            'one': {
                'joints': (-1.314, -2.370,-1.673, -0.668, 1.549, -3.737),
                'pose': (0.05474, -0.9312, -0.2554, 0.9099, 0.4145, -0.0115, -0.000836)
            },
            'two': {
                'joints': (0.287, -2.452, -1.57, -0.688, 1.542, -2.101),
                'pose': (0.9721, 0.0924, -0.2847, 0.9169, 0.3989, 0.0001, 0.0156)
            },
            'three': {
                'joints': (),
            ...
            # },
            'unfolded_fsm': {
                'joints': (-2.867, -2.101, 2.253, -0.203, 1.069, 0.076),
                'pose': (0.5011, 0.5280,  0.51949,  0.2832,  0.6315, 0.6720, 0.2633)
            },
            'folded_fsm': {
                'joints': (-1.273, -1.840, 2.028, 0.522, 1.251, -0.351),
                'pose': (-0.470, 0.5028, 0.3145, -0.3495, 0.8295, 0.4148, -0.1320)
            },
            'unfolded_front_fsm': {
                'joints': (),
                'pose': (0.52306, -0.50613, 0.51959, 0.64783, 0.24320, 0.28587, 0.66290)
            },
            # 'folded_fsm': {
            #     'joints': (),
